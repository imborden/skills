/* deck-stage.js — standalone <deck-stage> web component for HTML slide decks.
 *
 * USAGE (plain HTML — this is the supported form here):
 *   1. Place this file next to your deck .html.
 *   2. Load it: <script src="deck-stage.js"></script>
 *   3. Author slides as <section data-label="..."> children of
 ...
 *   </deck-stage>
 *
 * The component absolutely-positions and scales each slotted <section> itself —
 * do NOT set position/inset/width/height on the <section> elements.
 * Vanilla JS, no dependencies. Host postMessage hooks degrade to no-ops.
 */
/* BEGIN USAGE */
/**
